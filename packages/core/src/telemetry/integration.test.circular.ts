...
import { RumEvent } from './nebius-logger/event-types.js';
import { Config } from '../config/config.js';

describe('Circular Reference Integration Test', () => {
  it('should handle HttpsProxyAgent-like circular references in nebius logging', () => {
    ...
    // Test that NebiusLogger can handle this
    const logger = NebiusLogger.getInstance(mockConfig);
