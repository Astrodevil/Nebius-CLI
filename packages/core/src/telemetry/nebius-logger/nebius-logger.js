...
export class NebiusLogger {
  ...
  static getInstance(config) {
    if (config === undefined || !config?.getUsageStatisticsEnabled())
      return undefined;
    if (!NebiusLogger.instance) {
      NebiusLogger.instance = new NebiusLogger(config);
      process.on(
        'exit',
        NebiusLogger.instance.shutdown.bind(NebiusLogger.instance),
      );
    }
    return NebiusLogger.instance;
  }
  ...
  async createRumPayload() {
    ...
    return {
      ...
      view: {
        id: this.viewId,
        name: 'nebius-code-cli',
      },
      events: [...this.events],
      _v: `nebius-code@${version}`,
    };
  }
  flushIfNeeded() {
...
//# sourceMappingURL=nebius-logger.js.map
