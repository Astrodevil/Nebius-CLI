 ...
 */
export declare const DEFAULT_QWEN_MODEL = 'Qwen/Qwen3-32B-fast';
export declare const DEFAULT_QWEN_FLASH_MODEL = 'qwen3-coder-flash';
export declare const DEFAULT_GEMINI_MODEL = 'Qwen/Qwen3-32B-fast';
