...
export declare const GEMINI_CONFIG_DIR = '.nebius';
export declare const DEFAULT_CONTEXT_FILENAME = 'NEBIUS.md';
export declare const MEMORY_SECTION_HEADER = '## Nebius Added Memories';
