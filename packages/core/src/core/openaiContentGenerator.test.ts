...
describe('OpenAIContentGenerator', () => {
  ...
  describe('constructor', () => {
    it('should initialize with basic configuration', () => {
      expect(OpenAI).toHaveBeenCalledWith({
        ...
        maxRetries: 3,
        defaultHeaders: {
          'User-Agent': expect.stringMatching(/^NebiusCode/),
        },
      });
    });

    it('should handle custom base URL', () => {
      vi.stubEnv('NEBIUS_BASE_URL', 'https://api.custom.com');
    ...
    it('should configure OpenRouter headers when using OpenRouter', () => {
      vi.stubEnv('NEBIUS_BASE_URL', 'https://openrouter.ai/api/v1');
      ...
      expect(OpenAI).toHaveBeenCalledWith({
        ...
        defaultHeaders: {
          'User-Agent': expect.stringMatching(/^NebiusCode/),
          'HTTP-Referer': 'https://github.com/Astrodevil/nebius-cli.git',
          'X-Title': 'Nebius CLI',
        },
      });
    });
  ...
  describe('metadata control', () => {
    ...
    it('should NOT include metadata for other base URLs', async () => {
      ...
      vi.stubEnv('NEBIUS_BASE_URL', 'https://api.openai.com/v1');
