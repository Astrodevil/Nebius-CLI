...
describe('quotaErrorDetection', () => {
  describe('isNebiusQuotaExceededError', () => {
    ...
    it('should not detect throttling errors as quota exceeded', () => {
      ...
      expect(isNebiusQuotaExceededError(error)).toBe(false);
    });
  ...
  describe('isNebiusThrottlingError', () => {
    ...
    it('should not detect throttling without 429 status in structured error', () => {
      ...
      expect(isNebiusThrottlingError(error)).toBe(false);
    });
