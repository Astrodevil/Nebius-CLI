...
import { NebiusOAuthProgress } from './NebiusOAuthProgress.js';
import { DeviceAuthorizationInfo } from '../hooks/useNebiusAuth.js';
...
describe('NebiusOAuthProgress', () => {
  ...
  describe('Loading state (no deviceAuth)', () => {
    it('should render loading state when deviceAuth is not provided', () => {
      ...
      expect(output).toContain('Waiting for Nebius OAuth authentication...');
    ...
    it('should render loading state with gray border', () => {
      ...
      expect(output).not.toContain('Nebius OAuth Authentication');
  ...
  describe('Props changes', () => {
    ...
    it('should reset to loading state when deviceAuth becomes null', () => {
      ...
      expect(lastFrame()).toContain(
        'Waiting for Nebius OAuth authentication...',
      );
  ...
  describe('Timeout state', () => {
    it('should render timeout state when authStatus is timeout', () => {
      ...
      const output = lastFrame();
      expect(output).toContain('Nebius OAuth Authentication Timeout');
