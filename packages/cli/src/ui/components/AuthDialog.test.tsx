...
describe('AuthDialog', () => {
  ...
  describe('GEMINI_DEFAULT_AUTH_TYPE environment variable', () => {
    it('should select the auth type specified by GEMINI_DEFAULT_AUTH_TYPE', () => {
      ...
      // The OpenAI-compatible flow is now labeled as Nebius API Key (OpenAI Compatible)
      // and appears as the first option.
      expect(lastFrame()).toContain('● 1. Nebius API Key (OpenAI Compatible)');
    });
    ...
    it('should fall back to default if GEMINI_DEFAULT_AUTH_TYPE is not set', () => {
      ...
      // Default is Nebius API Key option (first option)
      expect(lastFrame()).toContain('● 1. Nebius API Key (OpenAI Compatible)');
    });
    ...
    it('should show an error and fall back to default if GEMINI_DEFAULT_AUTH_TYPE is invalid', () => {
      ...
      // it will just show the default Nebius API Key option
      expect(lastFrame()).toContain('● 1. Nebius API Key (OpenAI Compatible)');
    });
  });
