...
interface NebiusOAuthProgressProps {
  onTimeout: () => void;
  onCancel: () => void;
...
export function NebiusOAuthProgress({
  onTimeout,
  onCancel,
  deviceAuth,
  authStatus,
  authMessage,
}: NebiusOAuthProgressProps): React.JSX.Element {
    ...
    return (
      ...
      >
        <Text bold color={Colors.AccentRed}>
          Nebius OAuth Authentication Timeout
        </Text>
  ...
  if (!deviceAuth) {
    return (
      ...
      >
        <Box>
          <Text>
            <Spinner type="dots" /> Waiting for Nebius OAuth authentication...
          </Text>
        </Box>
        <Box marginTop={1} justifyContent="space-between">
          <Text color={Colors.Gray}>
