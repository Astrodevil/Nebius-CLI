...
import { loadServerHierarchicalMemory } from '@nebius-code/nebius-code-core';
          ...
          addItem(
            {
              ...
              text: `Successfully added NEBIUS.md files from the following directories if there are:\n- ${added.join('\n- ')}`,
            },
            Date.now(),
          );
        } catch (error) {
