...
import { Config, GitService, Logger } from '@nebius-code/nebius-code-core';
...
export interface OpenDialogActionReturn {
  type: 'dialog';
  dialog: 'auth' | 'theme' | 'editor' | 'privacy' | 'models' | 'branches';
  /** Optional payload for dialogs that require extra data (e.g., models). */
  models?: Array<{
    id: string;
    name: string;
    description?: string;
...
export interface SlashCommand {
   ...
   * For example, it could complete a tag for `/chat resume <tag>`.
   */
  completion?: (
    context: CommandContext,
    partialArg: string,
