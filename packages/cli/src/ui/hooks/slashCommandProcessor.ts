                ...
                case 'dialog':
                  switch (result.dialog) {
                    ...
                    case 'privacy':
                      ...
                      return { type: 'handled' };
                    case 'models':
                      // Forward the payload to the App via event to open the model dialog
                      appEvents.emit(AppEvent.ShowModelDialog, {
                        models: result.models ?? [],
                        currentModel: result.currentModel ?? '',
                      });
                      return { type: 'handled' };
                    case 'branches':
                      // Forward the payload to the App via event to open the branch dialog
                      appEvents.emit(AppEvent.ShowBranchDialog, {
