  ...
  try {
    ...
    if (process.platform === 'darwin') {
      try {
        ...
        // Brew is not installed or nebius-cli is not installed via brew.
    ...
    if (realPath.includes('/.pnpm/global')) {
      const updateCommand = 'pnpm add -g @nebius-code/nebius-code@latest';
      return {
    ...
    if (realPath.includes('/.yarn/global')) {
      const updateCommand = 'yarn global add @nebius-code/nebius-code@latest';
      return {
    ...
    if (realPath.includes('/.bun/bin')) {
      const updateCommand = 'bun add -g @nebius-code/nebius-code@latest';
      return {
    ...
    // Assume global npm
    const updateCommand = 'npm install -g @nebius-code/nebius-code@latest';
    return {
